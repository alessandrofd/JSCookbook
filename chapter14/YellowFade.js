/**
 * Created by Alessandro.Dantas on 21/07/2014.
 */
...
// This is the list of steps that will be used for the color to fade out.
...
// See http://wwww.scottandrew.com/weblog/articles/cbs-events for more information
...
// The function that initializes the fade and hooks the script to the page
function initFades() {
    if (!W3CDOM) return;
...
// This section searches the page body for anchors and adds onclick events so that their targets get highlighted
    ...
    for (var i = 0; i < anchors.length; i++) {
        // If there's a '#' in the anchors href
...
// This is the recursive function that actually performs the fade
